...
create() {
	...
	/bin/bash $(pwd)/configure --with-sysroot=$ROOT_DIR --prefix=$JANUS_DST_DIR --enable-post-processing CFLAGS=-I$ROOT_DIR/usr/include PKG_CONFIG_PATH=$ROOT_DIR/usr/lib/pkgconfig PKG_CONFIG_PATH=$ROOT_DIR/usr/lib/x86_64-linux-gnu/pkgconfig
