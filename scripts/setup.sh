...
if [ "$IMAGE_TOOL" != "none" ]; then 
	# NOTE: Currently it is impossible to create the target image using Podman hence we install docker unless IMAGE_TOOL is set to "none"
