...
BUILD_IMAGE_INFO_FILE=$TOP_DIR/build.info
...
if [ ! -d "$STAGING_DIR/libsrtp-2.2.0" ]; then
...
export PKG_CONFIG_PATH=$ROOT_DIR/usr/lib/pkgconfig:$ROOT_DIR/usr/lib/x86_64-linux-gnu/pkgconfig:$ROOT_DIR/usr/lib64/pkgconfig
/bin/bash $(pwd)/configure --prefix=$JANUS_DST_DIR CFLAGS='-I$ROOT_DIR/usr/include -gdwarf-2 -g3 -O0 -fno-builtin' CXXFLAGS='-I$ROOT_DIR/usr/include -gdwarf-2 -g3 -O0 -fno-builtin'
