...
are stored in this project and used by the target image (so far only the _start.sh_ script from this project is used in the target image) you must recreate the build image.
